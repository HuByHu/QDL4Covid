...
from models.CustomLayers import encoding
...
class LogisticGAN(GANLoss):
    ...
    def dis_loss(self, real_samps, fake_samps, height, alpha, r1_gamma=10.0):
        # Obtain predictions
        # print('real:', real_samps)
        # print('fake:', fake_samps)
        # real_samps = encoding(real_samps)
        # fake_samps = encoding(fake_samps)
        r_preds = self.dis(real_samps, height, alpha)
        f_preds = self.dis(fake_samps, height, alpha)
        # print('r_preds', r_preds)
        # print('f_preds', f_preds)
